...
source "qemu" "gnome-9-x86_64" {
  vm_name          = "almalinux-9-gnome-x86_64.qcow2"
...
build {
  ...
  provisioner "ansible" {
    ...
    playbook_file = "./${var.config_folder}alma-linux-9/ansible/gnome.yml"
  }
  ...
  provisioner "ansible" {
    ...
    playbook_file = "./${var.config_folder}alma-linux-9/ansible/default.yml"
    roles_path    = "./${var.config_folder}alma-linux-9/ansible/roles"
  }
